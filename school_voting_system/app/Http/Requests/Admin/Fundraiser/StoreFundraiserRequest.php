...
class StoreFundraiserRequest extends AdminFormRequest
{
    ...
    protected function fundraiserRules(): array
    {
        return [
            ...
            'min_donation' => ['nullable', 'numeric', 'min:'.Fundraiser::defaultMinimumDonationAmount()],
            'max_donation' => ['nullable', 'numeric', 'min:'.Fundraiser::defaultMinimumDonationAmount()],
            'allow_anonymous' => ['sometimes', 'boolean'],
            'generate_receipt' => ['sometimes', 'boolean'],
            'accept_cash' => ['sometimes', 'boolean'],
            'accept_qrph' => ['sometimes', 'boolean'],
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'accept_qrph' => $this->boolean('accept_qrph'),
