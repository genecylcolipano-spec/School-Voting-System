            ...
            <section class="rounded-2xl border border-violet-500/15 bg-slate-900/70 p-4 sm:p-6">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <?php if($canCreateTalent): ?>
                        <a href="<?php echo e(route('admin.talent-competition.create')); ?>" class="inline-flex min-h-9 items-center rounded-lg bg-violet-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-violet-500">Create</a>
                    <?php endif; ?>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.delete-action','data' => ['action' => route('admin.talent-competition.destroy', $event),'warning' => $talentWarning,'buttonClass' => 'inline-flex min-h-10 items-center rounded-lg border border-rose-500/30 px-3 py-2 text-sm font-semibold text-rose-300 hover:bg-rose-500/10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.talent-competition.destroy', $event)),'warning' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($talentWarning),'button-class' => 'inline-flex min-h-10 items-center rounded-lg border border-rose-500/30 px-3 py-2 text-sm font-semibold text-rose-300 hover:bg-rose-500/10']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <section class="rounded-2xl border border-violet-500/15 bg-slate-900/70 p-4 sm:p-6">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <?php if($canCreateEvents): ?>
                        <a href="<?php echo e(route('admin.events.create')); ?>" class="inline-flex min-h-9 items-center rounded-lg bg-violet-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-violet-500">Create</a>
                    <?php endif; ?>
                </div>
