<div class="relative w-full" data-super-admin-search>
    <label class="sr-only" for="<?php echo e($inputId); ?>">Search accounts, students, elections</label>
    <input
...
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/admin/partials/super-admin-search.blade.php ENDPATH**/ ?>