...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.faculty-portal','data' => ['title' => 'Fundraising','user' => $user,'notificationsCount' => $notificationsCount]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Fundraising','user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user),'notifications-count' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($notificationsCount)]); ?>
...
<?php endif; ?>
                    ...
                    <div class="p-5">
                        <div class="flex items-start justify-between gap-4">
                            <div class="min-w-0">
                                ...
                                <?php if($fundraiser->description): ?>
                                    <p class="mt-2 line-clamp-2 text-sm text-slate-300"><?php echo e($fundraiser->description); ?></p>
                                <?php endif; ?>
                            </div>
                        ...
                        <a href="<?php echo e(route('faculty.fundraising.show', $fundraiser)); ?>" class="mt-4 inline-flex min-h-10 items-center justify-center rounded-xl bg-gradient-to-r from-teal-500 to-emerald-400 px-4 py-2 text-sm font-semibold text-slate-950">
        ...
        <div class="overflow-x-auto"><?php echo e($fundraisers->links()); ?></div>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/faculty/fundraising/index.blade.php ENDPATH**/ ?>