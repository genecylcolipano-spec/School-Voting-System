...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-chart-panel','data' => ['title' => 'Participation Growth (Events/Voting)','subtitle' => 'Unique voters plus school events and talent competitions scheduled each month','type' => 'line','liveKey' => 'participation','labels' => $report['participation']['labels'],'values' => $report['participation']['values'],'yMax' => $report['participation']['yMax'],'yTicks' => $report['participation']['yTicks'],'valueSuffix' => $report['participation']['valueSuffix'],'accent' => '#34d399']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Participation Growth (Events/Voting)','subtitle' => 'Unique voters plus school events and talent competitions scheduled each month','type' => 'line','live-key' => 'participation','labels' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($report['participation']['labels']),'values' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($report['participation']['values']),'y-max' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($report['participation']['yMax']),'y-ticks' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($report['participation']['yTicks']),'value-suffix' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($report['participation']['valueSuffix']),'accent' => '#34d399']); ?>
