...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-popover','data' => ['align' => 'end','mobileTitle' => 'Account','widthClass' => 'w-72','panelClass' => 'border-cyan-500/20']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['align' => 'end','mobile-title' => 'Account','width-class' => 'w-72','panel-class' => 'border-cyan-500/20']); ?>
     <?php $__env->slot('trigger', null, []); ?> 
        <button
            type="button"
            class="inline-flex max-w-[14rem] items-center gap-2 rounded-xl border border-cyan-500/20 bg-slate-900/80 py-1.5 pl-1.5 pr-2.5 text-sm font-semibold text-white hover:bg-slate-800 sm:max-w-xs sm:pr-3"
            aria-haspopup="menu"
        >
...
<?php endif; ?>
        <div class="min-w-0 flex-1">
            ...
            <p class="mt-0.5 text-xs font-medium text-cyan-300"><?php echo e($roleLabel); ?></p>
    ...
    <div class="py-1">
        <a
            ...
            data-popover-close
            role="menuitem"
            class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-200 hover:bg-slate-800 hover:text-cyan-300"
        >
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/student/partials/account-menu.blade.php ENDPATH**/ ?>