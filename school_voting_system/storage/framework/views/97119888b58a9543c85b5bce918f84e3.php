                ...
                <tbody class="divide-y divide-slate-800">
                    <?php $__empty_1 = true; $__currentLoopData = $fundraisers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fundraiser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-slate-300">
                            ...
                            <td class="px-4 py-3 text-xs"><?php echo e($fundraiser['status']); ?></td>
                            <td class="px-4 py-3 text-center"><?php echo e(number_format($fundraiser['donations'])); ?></td>
                            <td class="px-4 py-3 text-right">₱<?php echo e(number_format((float) $fundraiser['goal'], 2)); ?></td>
                            <td class="px-4 py-3 text-right font-bold text-emerald-300">₱<?php echo e(number_format((float) $fundraiser['raised'], 2)); ?></td>
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <div class="h-2 w-28 overflow-hidden rounded-full bg-slate-800">
                                        <div class="h-full rounded-full bg-gradient-to-r from-violet-500 to-emerald-500" style="width: <?php echo e(min(100, $fundraiser['progress'])); ?>%"></div>
                                    </div>
                                    <span class="text-xs text-slate-400"><?php echo e(round($fundraiser['progress'])); ?>%</span>
                                </div>
                            </td>
                        </tr>
