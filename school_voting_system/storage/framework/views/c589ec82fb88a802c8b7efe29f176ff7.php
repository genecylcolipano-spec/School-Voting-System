...
<section
    ...
    <?php if($posterItems->isNotEmpty()): ?>
        x-data="{
            open: false,
            current: 0,
            posters: <?php echo \Illuminate\Support\Js::from($posterItems)->toHtml() ?>,
            openAt(index) {
                this.current = index;
                this.open = true;
            },
...
>
    ...
    <?php if($posterItems->isNotEmpty()): ?>
        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
            ...
            <?php $__currentLoopData = $posterItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $poster): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button
                    type="button"
                    @click="openAt(<?php echo e($index); ?>)"
                ...
                >
                    <img
                        src="<?php echo e($poster['url']); ?>"
                        alt="<?php echo e($poster['title']); ?>"
                        loading="lazy"
...
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/student/campaigns/_posters-section.blade.php ENDPATH**/ ?>