...
<div <?php echo e($attributes->class('flex shrink-0 items-center gap-3')); ?>>
    <?php if($logoUrl): ?>
        <img
            ...
            class="h-11 w-11 shrink-0 rounded-full border border-white/10 bg-white object-contain p-0.5 shadow-lg <?php echo e($shadowClass); ?>"
        ...
        >
        <div class="hidden h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br <?php echo e($gradient); ?> <?php echo e($iconClass); ?> shadow-lg <?php echo e($shadowClass); ?>" aria-hidden="true">
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
            </svg>
        </div>
    <?php else: ?>
        <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br <?php echo e($gradient); ?> <?php echo e($iconClass); ?> shadow-lg <?php echo e($shadowClass); ?>" aria-hidden="true">
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
            </svg>
        </div>
