...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-chart-panel','data' => ['title' => 'Participation Growth (Events/Voting)','subtitle' => 'Unique voters and scheduled events each month','type' => 'line','liveKey' => 'participation','labels' => $analyticsWidgets['participation']['labels'],'values' => $analyticsWidgets['participation']['values'],'yMax' => $analyticsWidgets['participation']['yMax'],'yTicks' => $analyticsWidgets['participation']['yTicks'],'valueSuffix' => $analyticsWidgets['participation']['valueSuffix'],'accent' => '#34d399','emptyMessage' => 'No voters or scheduled events this year.','footerLink' => route('admin.analytics.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Participation Growth (Events/Voting)','subtitle' => 'Unique voters and scheduled events each month','type' => 'line','live-key' => 'participation','labels' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($analyticsWidgets['participation']['labels']),'values' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($analyticsWidgets['participation']['values']),'y-max' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($analyticsWidgets['participation']['yMax']),'y-ticks' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($analyticsWidgets['participation']['yTicks']),'value-suffix' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($analyticsWidgets['participation']['valueSuffix']),'accent' => '#34d399','empty-message' => 'No voters or scheduled events this year.','footer-link' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.analytics.index'))]); ?>
