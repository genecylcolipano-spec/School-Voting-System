...
<body class="min-h-screen bg-slate-950 text-slate-100">
    <div class="mx-auto flex min-h-screen max-w-lg flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <p class="text-xs font-semibold uppercase tracking-wide text-amber-300"><?php echo e(\App\Support\SchoolBranding::systemName()); ?></p>
        ...
        <p class="mt-4 text-sm leading-relaxed text-slate-400"><?php echo e($message); ?></p>
        <?php if($returnAt): ?>
            <p class="mt-4 rounded-xl border border-slate-800 bg-slate-900/70 px-4 py-3 text-sm text-slate-300">
                Estimated return:
                <span class="font-semibold text-white"><?php echo e($returnAt->timezone(config('app.timezone'))->format('M d, Y g:i A')); ?></span>
            </p>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/maintenance.blade.php ENDPATH**/ ?>