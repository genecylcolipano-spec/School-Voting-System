...
<head>
    ...
    <title>Enrollment Link Expired — <?php echo e(\App\Support\SchoolBranding::systemName()); ?></title>
...
<body class="min-h-screen bg-slate-950 font-[Instrument_Sans] text-slate-100 antialiased">
    <div class="flex min-h-screen items-center justify-center px-4 py-12">
        <div class="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
            <p class="text-xs font-semibold uppercase tracking-[0.3em] text-amber-300/80"><?php echo e(\App\Support\SchoolBranding::systemName()); ?></p>
...
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/auth/register-expired.blade.php ENDPATH**/ ?>