        ...
        <div class="relative w-full max-w-md">
            <div class="mb-5 text-center">
                <?php if($loginLogo = \App\Support\SchoolBranding::logoUrl(withFallback: false)): ?>
                    <img src="<?php echo e($loginLogo); ?>" alt="<?php echo e(\App\Support\SchoolBranding::schoolName()); ?>" class="mx-auto h-14 w-14 rounded-full border border-white/10 bg-white object-contain p-0.5 shadow-lg shadow-cyan-900/30" onerror="this.classList.add('hidden'); const fallback = this.nextElementSibling; if (fallback) { fallback.classList.remove('hidden'); fallback.classList.add('flex'); }">
                ...
                <?php endif; ?>
                <p class="mt-3 text-xs font-semibold uppercase tracking-[0.35em] text-cyan-300/80"><?php echo e(\App\Support\SchoolBranding::systemName()); ?></p>
                <?php if($poweredBy !== ''): ?>
                ...
                <?php if($periodLabel !== ''): ?>
                    <p class="mt-2 text-sm text-slate-400"><?php echo e($periodLabel); ?></p>
                <?php endif; ?>
            </div>
                ...
                <p class="mt-4 flex flex-col gap-2 text-center text-xs text-slate-400">
                    <?php if($registrationEnabled): ?>
                        <span>
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="font-medium text-cyan-300 hover:text-cyan-200">Create one</a>
                        </span>
                    <?php endif; ?>
                    <?php if($recoveryEnabled): ?>
                        <span>
                            Forgot your passkey?
                            <a href="<?php echo e(route('login.recovery')); ?>" class="font-medium text-cyan-300 hover:text-cyan-200">Recover access</a>
                        </span>
                    <?php endif; ?>
                    </p>
                </div>
