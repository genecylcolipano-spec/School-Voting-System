...
<?php endif; ?>
                        ...
                        <div class="p-5">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('student.announcements.show', $announcement)); ?>" class="mt-4 inline-flex rounded-xl border border-cyan-500/30 px-4 py-2 text-sm font-semibold text-cyan-200 hover:bg-cyan-500/10">
                                Read more
                            </a>
                        </div>
                    </article>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/student/announcements/index.blade.php ENDPATH**/ ?>