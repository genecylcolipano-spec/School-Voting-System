...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="sm:col-span-2" x-data="schoolLogoPreview(<?php echo \Illuminate\Support\Js::from($logoUrl)->toHtml() ?>)">
                        <label class="block text-sm font-medium text-slate-300">School Logo</label>
                        <?php if(($logoIssue ?? null) === 'missing_file'): ?>
