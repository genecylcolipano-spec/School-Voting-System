...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-portal','data' => ['title' => 'Fundraisers','user' => $user,'notificationsCount' => $notificationsCount]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $fundraisers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fundraiser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="border-b border-slate-800/80 text-slate-200">
                            <td class="px-4 py-3"><?php echo e($fundraiser->title); ?></td>
                            <td class="px-4 py-3">₱<?php echo e(number_format((float) $fundraiser->amount_raised, 2)); ?></td>
                            <td class="px-4 py-3">₱<?php echo e(number_format((float) $fundraiser->goal_amount, 2)); ?></td>
                            <td class="px-4 py-3"><?php echo e($fundraiser->displayStatusLabel()); ?></td>
                            <td class="px-4 py-3 whitespace-nowrap">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $fundraiser)): ?>
                                    <a href="<?php echo e(route('admin.fundraisers.edit', $fundraiser)); ?>" class="text-violet-300 hover:text-violet-200">Manage</a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $fundraiser)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.delete-action','data' => ['action' => route('admin.fundraisers.destroy', $fundraiser),'warning' => $deleteWarning]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.fundraisers.destroy', $fundraiser)),'warning' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($deleteWarning)]); ?>
...
<?php endif; ?>
        ...
        <div class="mt-6"><?php echo e($fundraisers->links()); ?></div>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/admin/fundraisers/index.blade.php ENDPATH**/ ?>