...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($rosterLabel . ' Roster'),'user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user),'notifications-count' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($notificationsCount)]); ?>
        ...
        <div class="mb-6 flex flex-wrap justify-end gap-3">
            <a href="<?php echo e(route($routePrefix.'.create')); ?>" class="rounded-xl border border-violet-500/30 px-4 py-2 text-sm font-semibold text-violet-300 hover:bg-violet-500/10">Add record</a>
            ...
            <?php if($supportsYearlySync ?? false): ?>
                <a href="<?php echo e(route($routePrefix.'.year-sync')); ?>" class="rounded-xl border border-amber-500/30 px-4 py-2 text-sm font-semibold text-amber-200 hover:bg-amber-500/10">Yearly sync</a>
            <?php endif; ?>
        ...
        <form method="GET" class="mb-6 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <input name="q" type="search" value="<?php echo e(request('q')); ?>" placeholder="<?php echo e($searchPlaceholder); ?>"
            ...
            <?php if($hasFilters ?? false): ?>
                <a href="<?php echo e(route($routePrefix.'.index')); ?>" class="w-full rounded-xl border border-slate-700 px-4 py-2 text-center text-sm font-semibold text-slate-300 hover:bg-slate-800 sm:w-auto">Clear</a>
            <?php endif; ?>
        </form>
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <?php if($portalAccountUrl): ?>
                                        <a href="<?php echo e($portalAccountUrl); ?>" class="rounded-lg border border-sky-500/30 px-3 py-1.5 text-xs font-semibold text-sky-200 hover:bg-sky-500/10">Portal account</a>
                                    <?php endif; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e(4 + count($extraFields)); ?>" class="px-4 py-6 text-slate-400">No roster records yet. Add a record or import a CSV to begin.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
