...
unset($__errorArgs, $__bag); ?>
                ...
                <?php echo $__env->make('admin.partials.phone-field', ['phoneValue' => old('phone', $student->phone)], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input id="school_year" name="school_year" type="text" value="<?php echo e(old('school_year', $student->school_year)); ?>"
                            class="mt-1 w-full rounded-xl border border-slate-700 bg-slate-950/50 px-4 py-2.5 text-white focus:border-violet-500/50 focus:outline-none focus:ring-2 focus:ring-violet-500/20"
            ...
            <aside class="rounded-2xl border border-violet-500/15 bg-slate-900/70 p-5 sm:p-6">
                ...
                <dl class="mt-4 space-y-3 text-sm">
                    ...
                    <div class="flex justify-between gap-3 border-b border-slate-800 pb-2">
                        ...
                        <dd class="break-all text-slate-200"><?php echo e($student->email); ?></dd>
                    </div>
                    <div class="flex justify-between gap-3 border-b border-slate-800 pb-2">
                        <dt class="text-slate-500">Phone</dt>
                        <dd class="text-slate-200"><?php echo e($student->phone ?: 'Not on file'); ?></dd>
                    </div>
                    <div class="flex justify-between gap-3 border-b border-slate-800 pb-2">
