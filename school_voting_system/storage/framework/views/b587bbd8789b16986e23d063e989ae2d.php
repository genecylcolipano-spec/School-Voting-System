                        ...
                        <div class="flex items-start justify-between gap-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <?php endif; ?>
                                    <?php if($motto !== ''): ?>
                                        <p class="mt-1 text-xs italic text-slate-500">"<?php echo e($motto); ?>"</p>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php endif; ?>
                        ...
                        <?php if($showPlatform): ?>
                            <p class="mt-3 text-sm text-slate-400"><?php echo e(\Illuminate\Support\Str::limit($platform, 160)); ?></p>
                        <?php endif; ?>
                        ...
                        <div class="mt-3 flex flex-wrap gap-3 text-xs text-slate-500">
                            ...
                            <span><?php echo e($uploadedPosters->count()); ?> poster(s)</span>
                            <?php if($partylist->leader): ?>
                                <span>Leader: <?php echo e($partylist->leader); ?></span>
                            <?php endif; ?>
                        </div>
                        <?php if($electionTitles->isNotEmpty()): ?>
                            <p class="mt-1 text-xs text-slate-500">
                                Attached to:
                                <?php echo e($electionTitles->take(2)->implode(', ')); ?><?php echo e($electionTitles->count() > 2 ? ' +'.($electionTitles->count() - 2).' more' : ''); ?>
                        ...
                        <div class="mt-4">
                            ...
                            <?php if($uploadedPosters->isNotEmpty()): ?>
                                <div class="mt-2 flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $uploadedPosters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poster): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="group relative overflow-hidden rounded-lg border border-slate-800">
                                            <a
                                                href="<?php echo e($poster->file_url); ?>"
                                                target="_blank"
                                                rel="noopener"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $partylist)): ?>
                                                <form method="POST" action="<?php echo e(route('admin.campaigns.poster.destroy', [$partylist, $poster])); ?>" class="absolute right-1 top-1" onsubmit="return confirm('Remove this poster?')">
                                                    <?php echo csrf_field(); ?>
                            ...
                            <?php if($brokenPosters->isNotEmpty()): ?>
                                <div class="mt-2 space-y-2">
                                    <?php $__currentLoopData = $brokenPosters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $poster): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between gap-3 rounded-lg border border-amber-500/20 bg-amber-500/5 px-3 py-2 text-xs text-amber-100">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $partylist)): ?>
                                                <form method="POST" action="<?php echo e(route('admin.campaigns.poster.destroy', [$partylist, $poster])); ?>" onsubmit="return confirm('Remove this missing poster record?')">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
