                ...
                <?php $__currentLoopData = $elections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $election): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <article class="rounded-2xl border border-violet-500/15 bg-slate-900/70 p-4">
                        <div class="flex flex-wrap items-start justify-between gap-2">
                            <h3 class="min-w-0 text-base font-semibold text-white"><?php echo e($election->title); ?></h3>
...
<?php endif; ?>
                        ...
                        <dl class="mt-3 grid grid-cols-2 gap-2 text-sm text-slate-300">
                            <div>
                                ...
                                <dd class="font-semibold text-white"><?php echo e($election->categories_count); ?></dd>
                            </div>
                            <div>
                                <dt class="text-[10px] uppercase tracking-wide text-slate-500">Candidates</dt>
                                <dd class="font-semibold text-white"><?php echo e($election->candidates_count); ?></dd>
                            </div>
                            <div>
                                <dt class="text-[10px] uppercase tracking-wide text-slate-500">Campaigns</dt>
                                <dd class="font-semibold text-white"><?php echo e($election->partylists_count); ?></dd>
                            </div>
                            <div>
