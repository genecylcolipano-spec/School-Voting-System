...
<head>
    ...
    <title>Identity Verified — <?php echo e(\App\Support\SchoolBranding::systemName()); ?></title>
    ...
    <div class="flex min-h-screen items-center justify-center px-4 py-12">
        <div class="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
            ...
            <div class="mt-6 space-y-3 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-4 text-sm text-emerald-100">
                ...
                <p>This setup link expires in <span class="font-semibold"><?php echo e($expirationHours); ?> hours</span>.</p>
                <?php if($emailSent ?? false): ?>
                    <p class="text-emerald-200/80">We also emailed instructions to <span class="font-medium"><?php echo e($email); ?></span>.</p>
                <?php endif; ?>
            </div>

            <a href="<?php echo e($enrollUrl); ?>"
...
<?php /**PATH C:\xampp\htdocs\voting system\school_voting_system\resources\views/auth/register-verified.blade.php ENDPATH**/ ?>