...
<body style="font-family: Arial, Helvetica, sans-serif; color: #111827; line-height: 1.5;">
    ...
    <p>Complete your secure passkey setup within {{ $expiresInHours }} hours to activate your account.</p>
    ...
    <p style="color: #6b7280; font-size: 13px; word-break: break-all;">
        Or open this link: {{ $enrollmentUrl }}
    </p>

    <p style="color: #6b7280; font-size: 13px;">
        This one-time link expires in {{ $expiresInHours }} hours. If it expires, start Create Account again.
    </p>
