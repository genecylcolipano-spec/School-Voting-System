...
<section>
    <div class="mb-4">
        <h2 class="text-xl font-bold text-white">{{ $activitiesTitle }}</h2>
        <p class="mt-1 text-sm text-slate-400">{{ $activitiesDescription }}</p>
    </div>

    <div class="overflow-hidden rounded-2xl border {{ $activitiesBorder }} bg-slate-900/70 shadow-sm shadow-black/20">
