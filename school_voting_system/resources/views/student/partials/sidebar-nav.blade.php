...
<nav class="flex-1 space-y-1 overflow-y-auto px-3 py-4">
    ...
    <x-portal-sidebar-link
        ...
        label="Events"
        :active="request()->routeIs('student.events.*')"
    >
        <x-slot:icon>
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <x-portal-sidebar-link
        ...
        label="My Voting"
        :active="request()->routeIs('student.voting.*')"
    >
        <x-slot:icon>
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <x-portal-sidebar-link
        ...
        label="Campaigns"
        :active="request()->routeIs('student.campaigns.*')"
    >
        <x-slot:icon>
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <x-portal-sidebar-link
        ...
        :active="request()->routeIs('student.talent-voting.*') || request()->routeIs('student.talent-registration.*')"
    >
        <x-slot:icon>
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <x-portal-sidebar-link
        ...
        label="Fundraising"
        :active="request()->routeIs('student.fundraising.*')"
    >
        <x-slot:icon>
            <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
