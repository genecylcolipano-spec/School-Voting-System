    ...
    <x-admin-portal :title="$account->name" :user="$user" :notifications-count="$notificationsCount">
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <form method="POST" action="{{ route('super-admin.staff.enrollment', $account) }}" onsubmit="return confirm('Generate a passkey reset / enrollment link? This emails the address on file.');">
                    @csrf
